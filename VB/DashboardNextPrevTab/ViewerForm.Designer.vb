Namespace DashboardNextPrevTab
	Partial Public Class ViewerForm
		...
		Private Sub InitializeComponent()
			...
			DirectCast(Me.imageCollection, System.ComponentModel.ISupportInitialize).BeginInit()
			Me.SuspendLayout()
			' 
			' dashboardViewer
			' 
			...
			DirectCast(Me.imageCollection, System.ComponentModel.ISupportInitialize).EndInit()
